<div class="panel">
	...
	<div class="panel__content">
		<div class="textfield--float-label">
			...
			<input id="stripe-gateway-card-number" data-stripe="number" class="stripe-input-field" placeholder="<?php echo stripe_manager()->get_option('donation_card_number_placeholder')?>"/>
		</div>
		...
		<div class="textfield--float-label">
			...
			</span> <?php echo stripe_manager()->get_option('donation_card_expiration_date_label')?>
			</label>
			<input id="stripe-gateway-exp-date" data-stripe="exp" class="stripe-input-field" placeholder="<?php echo stripe_manager()->get_option('donation_card_expiration_date_placeholder')?>"/>
		</div>

		<?php if(stripe_manager()->is_active('donation_cvv_field_enabled')){?>
			<div class="textfield--float-label <?php if(!stripe_manager()->is_active('donation_postal_field_enabled')){echo 'text-field-float-100';}?>">
				...
				</span> <?php echo stripe_manager()->get_option('donation_card_cvv_label')?>
				</label>
		...
		<?php if(stripe_manager()->is_active('donation_postal_field_enabled')){?>
			<div class="textfield--float-label <?php if(!stripe_manager()->is_active('donation_cvv_field_enabled')){echo 'text-field-float-100';}?>">
				...
				</span> <?php echo stripe_manager()->get_option('donation_card_postal_label')?>
				</label>
