 ...
 *
 */
class Stripe_Donation_Payment_Settings extends Stripe_Gateway_Settings_API
{

    public function __construct ()
    {
        $this->title = false;
        $this->id = 'donation_card_settings';
    ...
    public function output_form_settings ($key, $data)
    {
    ...
    {
        return array(
                'donation_credit_card_form' => array(
                ...
                'donation_card_loader_enabled' => array(
                ...
                'donation_card_loader_html' => array(
                ...
                'donation_card_loader_css' => array(
